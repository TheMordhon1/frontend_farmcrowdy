          ...
          <div class="flex items-center pt-10 px-5 md:px-0">
            <div class="w-1/2">
              <h1 class="text-4xl text-white mb-5">
                Platform Untuk Membantu<u class="hero-underline"> Petani</u> Untuk
                 Mendapatkan<u class="hero-underline"> Akses Permodalan
              </u>
                Sesuai Yang Diperlukan
              </h1>
 
              <p class="text-white text-xl font-light mb-8">
                Mendanai projek yang terbaik untuk 
                 <br />
        ...
        <div class="flex justify-between items-center text-center">
          <div class="w-1/3">
            ...
            <div class="step-content">
              ...
              <p class="font-light">
                Buat akun dan mulai 
              <br />untuk membuat projek dan berinvestasi
              </p>
            </div>
          </div>
          <div class="w-1/3">
            ...
            <div class="step-content">
              <h3 class="font-medium">Buka Projek</h3>
              <p class="font-light">
            ...
            <div class="item">
              ...
              <div class="item-meta">
                ...
                <p class="text-md font-light text-gray-900">
                  Memenuhi kebutuhan  daging sapi harian
                </p>
